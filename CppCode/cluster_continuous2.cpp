...
/* NEW FUNCTIONS FOR CONTINUOUS CASE */
...
// [[Rcpp::export]]
List cluster(vec y, mat X, mat matX, ivec Sy, ivec Sx,
	     mat betaY, vec sig2, mat xPiPars, mat xMuPars, mat xSigPars,
	     double alphapsi, double alphatheta, vec h0y, vec h0i,
	     imat uniqueS, 
	     double c0, double mu0,
	     double nu0, double tau,
	     double a0, double b0,
	     double betaa0, double betab0,
	     vec betainit, mat diagbetacov0,
	     int p1, int ptx, int p2) {
  /* 
